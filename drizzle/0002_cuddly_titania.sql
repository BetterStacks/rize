...
ALTER TABLE "profile_views" ADD CONSTRAINT "profile_views_viewer_profile_id_profile_id_fk" FOREIGN KEY ("viewer_profile_id") REFERENCES "public"."profile"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
