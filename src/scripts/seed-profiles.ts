...
async function generateExperience(profileId: string, metadata: any) {
  const experiences = [];
...
async function generateEducation(profileId: string, metadata: any) {
  return [{
    profileId,
...
async function generatePost(profileId: string, metadata: any) {
