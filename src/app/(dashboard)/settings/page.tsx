  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      ...
      <div className="w-full max-w-3xl mb-6 pt-6">
        <Link href={session.user.username ? `/${session.user.username}` : '/explore'}>
          <Button variant="ghost" size="sm" className="flex items-center gap-2 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100">
