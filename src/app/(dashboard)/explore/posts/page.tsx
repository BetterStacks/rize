...
import {
  deleteCustomFeed,
  getMyCustomFeeds,
} from "@/actions/custom-feed-actions";
...
const page = () => {
  ...
  const isCustomMode = !["recent", "trending", "following", "custom"].includes(
    mode,
  );
              ...
              return (
                <div key={feed.id} className="group relative flex items-center">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      align="start"
                      className="w-40 mt-4 dark:bg-dark-bg dark:border-dark-border"
                    >
                      <DropdownMenuItem
                        onClick={(e) => {
                          e.stopPropagation();
          ...
          {mode !== "following" && (
            <div className="flex flex-row items-center gap-2">
              <Popover>
                ...
                <PopoverContent
                  className="w-60 dark:bg-dark-bg dark:border-dark-border rounded-xl overflow-hidden p-0"
                  align="end"
                >
                  <Command>
                    <CommandInput
